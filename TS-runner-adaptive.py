...
def process_report_regex(regex):
	...
	for period in pynum.arange(min_period, max_period, step_period):
		...
		com = "python ts-simple-adaptive.py " + str(pFile) + " " + table + " " + str(period)
		cmd.put(com)
	...
	while (cmd.qsize()>0):
		...
		if (psutil.cpu_percent()<95 and ram_util()<80 ):
...
if __name__ == "__main__":
	...
	# python TS-runner-adaptive.py 01k_77j1_1_optimized 01k_10j1_1   , another_pattern, another_pattern...
	# todo: same with BTC
